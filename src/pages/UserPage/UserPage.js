...
const UserPage = ({ match }) => {
  const { user, loading, getUser } = useContext(usersContext);
                    ...
                    <div className='avatar-card'>
                      ...
                      <div className='title'>
                        <div className='grid fc-black-800'>
                          319 &nbsp;
                          <span className='fc-light'>REPUTATION</span>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className='info-cell'>
                        <div className='info'>
                          ...
                          <div className='date'>
                            <p>
                              user created &nbsp;-&nbsp;
                              {moment(user.created_at).fromNow(true)} ago
                            </p>
                          </div>
                        </div>
                      </div>
