...
const Post = ({
  ...
  const onChangeAnswer = (e) =>
    setFormDataAnswer({ ...formData, [e.target.name]: e.target.value });
                        ...
                        <div className='post-btns'>
                          <div className='post-menu'>
                            ...
                            {!auth.loading &&
                              ...
                              parseInt(post.user_id) === auth.user.id && (
                                <Link
                        ...
                        <div className='post-owner'>
                          <div className='user-block fc-black-500'>
                            <div className='action-time'>
                              asked {moment(post.created_at).fromNow(true)} ago
                            </div>
                  ...
                  <div className='answer-sub-header'>
                    ...
                    <div className='grid--cell'>
                      <div className=' grid s-btn-group js-filter-btn'>
                        <Link
                          className='s-btn s-btn__filled is-selected'
                          to='#'
                          data-nav-xhref=''
                        ...
                        <div className='answer-actions'>
                          <div className='action-btns'>
                            <div className='answer-menu'>
                              ...
                              {!auth.loading &&
                                auth.isAuthenticated &&
                                parseInt(answer.user_id) === auth.user.id && (
                                  <Link
                                    className='s-link s-link__danger'
                                    style={{ paddingLeft: "4px" }}
                  ...
                  {!auth.loading && auth.isAuthenticated ? (
                    ...
                    <Fragment>
                      <Link to='/login'>
                        ...
                        >
                          You need to login to add an answer
                        </button>
                      </Link>
                    </Fragment>
                  )}
